...
boxsize   = [0.0025,0.0025]      # pixel size width by height, in meters, used by smartmove
...
motor1_length = 1.46		   # length of motor1 wire, in meters
motor2_length = 1.46           # length of motor2 wire, in meters (currently has to be the same as wire1)
